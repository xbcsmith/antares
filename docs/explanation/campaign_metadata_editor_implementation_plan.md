...
- I’ll proceed with a small, iterative code extraction (Phase 1) in a feature branch, followed by UI layout refactor (Phase 2), validation additions (Phase 3), and `main.rs` refactor (Phase 4).
- Pause after each Phase for a review and UX signoff before proceeding to the next phase.

Please review and confirm when I may start Phase 1.
