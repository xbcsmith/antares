...
//
// Unit tests for MenuState and related menu types.
...
fn test_menu_state_get_resume_mode_returns_previous() {
    // Create a Combat state to ensure non-trivial variants are preserved
    let combat_mode = GameMode::Combat(crate::domain::combat::engine::CombatState::new(
